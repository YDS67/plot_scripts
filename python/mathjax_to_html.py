...
def convert_mathjax_to_html(mathjax_string):
    """
...
# Example usage
mathjax_input = (
    "This is a formula $\\sqrt{x^2+y^2} = r$ and $x = r \\cos(\\theta)$ and $y = r \\sin(\\theta)$ in a sentence."
)

html_output = convert_mathjax_to_html(mathjax_input)
